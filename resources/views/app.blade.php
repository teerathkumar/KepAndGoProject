...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ Vite::asset('resources/assets/css/custom.css')  }}"  rel="stylesheet" />
        ...
        <!-- Font Awesome Icons -->
        <script src="https://kit.fontawesome.com/a241685d79.js" crossorigin="anonymous"></script>
        <!-- CSS Files -->
...
{{--        <script type="module"  src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js"></script>--}}
        @stack('rtl')
        @stack('dashboard')
        <!-- <script>
