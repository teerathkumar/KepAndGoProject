...
<aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div className="sidenav-header">
    ...
    <a className="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
      ...
      <ul className="navbar-nav">
          <li className="nav-item">
              ...
              <NavLink href={route('dashboard')} active={route().current('dashboard')}>
                  {/*<a className="nav-link" active={route().current('dashboard')} href="{{ url('dashboard') }}">*/}
                  <div
          ...
          <li className="nav-item mt-2">
              <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Work Group</h6>
          </li>
          <li className="nav-item">
              ...
              <NavLink href={route('posts.index')}
                       active={route().current('posts.index') || route().current('posts.create')}>
          ...
          <li className="nav-item">
              <NavLink href={route('Leads.index')}
                       active={route().current('Leads.index') || route().current('Leads.create')}>
                  ...
                  <span className="nav-link-text ms-1">Leads</span>
              </NavLink>
          </li>
          <li className="nav-item">
              <NavLink href={route('Leads.index')}
          ...
          <li className="nav-item">
              <NavLink href={route('profile')} active={route().current('profile')}>
                  ...
                  <span className="nav-link-text ms-1">Branches/Locations</span>
              </NavLink>
          </li>
          <li className="nav-item">
              <NavLink href={route('profile')} active={route().current('profile')}>
          ...
          <li className="nav-item pb-2">
              <a className="nav-link {{ (Request::is('user-management') ? 'active' : '') }}"
                 href="{{ url('user-management') }}">
                  <div
                      className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i style={{fontSize: "1rem"}}
                         className="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }} "
                         aria-hidden="true"></i>
                  </div>
          ...
          <li className="nav-item">
              <a className="nav-link {{ (Request::is('profile') ? 'active' : '') }}" href="{{ url('profile') }}">
                  <div
                      className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                           xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
          ...
          <li className="nav-item">
              <a className="nav-link  " href="{{ url('static-sign-in') }}">
                  <div
                      className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li className="nav-item">
              <a className="nav-link  " href="{{ url('static-sign-up') }}">
                  <div
                      className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
