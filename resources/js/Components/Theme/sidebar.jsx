...
import mylogo from '@/img/logo-ct.png';
        ...
        <aside
            ...
            <div className="sidenav-header">
                ...
                <NavLink className="align-items-center d-flex m-0 navbar-brand text-wrap" href={route('dashboard')}>
                    ...
                    <img src={mylogo} className="navbar-brand-img h-100"
                         alt="..."/>
                ...
                <ul className="navbar-nav">
                    <li className="nav-item">
                        ...
                        <NavLink href={route('dashboard')}
                                 active={route().current('dashboard') || route().current() == null}>
                    ...
                    <li className="nav-item">
                        <NavLink href={route('services.index')}
                                 active={route().current('services.index') || route().current('services.create') || route().current('services.edit')}>
                            {/*<a className="nav-link {{ (Request::is('Leads') ? 'active' : '') }} " href="{{ url('Leads') }}">*/}
                            <div
                                className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
