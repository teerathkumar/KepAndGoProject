                ...
                <div className="mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar">
                    ...
                    <ul className="navbar-nav  justify-content-end">
                        ...
                        <li className="nav-item dropdown pe-2 d-flex align-items-center">
                            <a className="nav-link text-body p-2 cursor-pointer" id="dropdownMenuButton" data-bs-toggle="dropdown"
                               aria-expanded="false">
                                <i className="fa fa-bell  me-sm-2"></i>
                        ...
                        {/*User Profile things*/}
                        <li className="nav-item dropdown pe-2 d-flex align-items-center">
                            <a className="nav-link text-body p-0 cursor-pointer" id="dropdownUserMenuButton"
                            ...
                            <ul className="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                                ...
                                <li>
                                    <NavLink
                                        className={"dropdown-item border-radius-md text-body font-weight-bold"}
